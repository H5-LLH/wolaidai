							...
							<ul>
								<li>
									...
									<ul className="help-que-ans-box" style={{display: "none"}}>
										...
										<li>
											<div className="question">2.冻结的押金能否充当租金或者买断金额？</div>
											<div className="answer">抱歉，您冻结的押金金额不能抵扣租金或者到期后买断商品的金额，租金会在您的还款日当天通过支付宝免密支付方式还款，到期后若您需要买断商品，买断的金额也需要您自行支付。</div>
										</li>
										<li>
											<div className="question">3.什么时候退还押金？</div>
											<div className="answer">租期结束后，您完成回收或买断商品后的7个工作日内，剩余冻结的押金金额我们会退还，具体到账时间以通知时间为准。</div>
										</li>
									</ul>
								</li>
								<li>
									...
									<ul className="help-que-ans-box" style={{display: "none"}}>
										...
										<li>
											<div className="question">2.可以选择主动还租金吗？</div>
											<div className="answer">您可以在账单详情选择自主还款。</div>
										</li>
									</ul>
								</li>
								<li>
									...
									<ul className="help-que-ans-box" style={{display: "none"}}>
										...
										<li>
											<div className="question">2.可以提前退租吗？</div>
											<div className="answer">抱歉，租赁期间暂不支持提前回收和归还商品。</div>
										</li>
									</ul>
								</li>
								<li>
									...
									<ul className="help-que-ans-box" style={{display: "none"}}>
										...
										<li>
											<div className="question">2.退换货的运费由谁承担？</div>
											<div className="answer">自您签收之日起7天内，因商品质量问题或漏发错发而引起的退换货，运费由我们承担；因您个人原因导致的退换货，在商品未激活且不影响二次销售的情况下，退换货由您承担。</div>
										</li>
									</ul>
								</li>
								<li>
									...
									<ul className="help-que-ans-box" style={{display: "none"}}>
										...
										<li>
											<div className="question">2.超期忘记归还怎么办？</div>
											<div className="answer">您需在合约到期后7日内将商品寄回，若淘新机收到归还商品的日期超出租赁期限7日的，视为用户买断该商品，用户应在买断之日起2日内支付买断费。</div>
										</li>
										<li>
											<div className="question">3.归还商品后，商品里面的隐私会不会泄露？</div>
											<div className="answer">淘新机的强大的技术检修中心，有专业的工程师清理数据，保障您隐私安全。请您在归还商品前，自行将设备内的数据、信息等进行清除。如经淘新机专业工程师检测发现商品内还有留存的数据和信息，淘新机会进行彻底清除，如因此造成您数据丢失，淘新机不承担任何责任。</div>
										</li>
									</ul>
								</li>
								<li>
									...
									<ul className="help-que-ans-box" style={{display: "none"}}>
										...
										<li>
											<div className="question">2.能否提前买断商品？</div>
											<div className="answer">租赁期间暂不支持提前买断商品，如您因丢失或商品损坏至无法维修等特殊情况，您需要支付该租赁合约剩余应付租金和买断金额提前买断商品。</div>
										</li>
									</ul>
								</li>
								<li>
									...
									<ul className="help-que-ans-box" style={{display: "none"}}>
										<li>
											...
											<div className="answer">（1）将租赁物恢复至能完全正常使用之状态；</div>
											<div className="answer">（2）更换与租赁物同等型号、状态、性能的设备以完全代替租赁物，本合同继续履行；</div>
											<div className="answer">（3）如租赁物毁损致无法修复的，视为乙方同意提前买断租赁物，向甲方结清相关费用后，本合同终止。</div>
										</li>
										<li>
											<div className="question">2.租比买有什么优势？</div>
											<div className="answer">租机可以解决机器更换时处理旧机的烦恼，年年租最新款的机器；租金仅需每月支付，减轻一次性购买手机的资金压力；租机可以满足不同群体对手机的使用需求，环保共享，发挥最大价值。</div>
										</li>
										<li>
											<div className="question">3.手机成色如何？</div>
											<div className="answer">所售新机皆为全新国行正品。</div>
										</li>
										<li>
											<div className="question">4.可以7天无理由退换货吗？</div>
											<div className="answer">您在淘新机租赁的手机，自实际收货日期次日起7天内，手机未拆封、未激活，不影响二次销售，可申请无理由退换货。</div>
										</li>
									</ul>
								</li>
							</ul>
