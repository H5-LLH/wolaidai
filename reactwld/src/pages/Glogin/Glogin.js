		...
		return(
			...
			<div className="login_wrap" style={{display:(this.state.loginStatus? "block":"none")}}>
				...
				<div className="formInputGroup">
					...
					<div  role="presentation" className={this.state.jinyong ? "btn-loginn":"btn-loginn jinyong"} onClick={this.loginClick.bind(this)}>登录</div>
					{
						(()=>{
							if(this.state.jinyong){
								...
								return (<div className="btn-loginn" style={{position:"absolute",left:"0",top:"-37px",zIndex:"3",width:"65%",opacity:"0"}}>
					</div>)
							}
						})()
					}
